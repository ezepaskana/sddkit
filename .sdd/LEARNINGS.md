...
- **El bloque gestionado de CLAUDE.md está en 448 de 450 palabras** (tope del test en `agentsmd.test.js`): agregar una instrucción nueva obliga a reescribir otra, no a sumar. _(tarea 018)_
- **Una tarea que cambia una skill debe editar `skills/` (fuente del paquete, `PKG_SKILLS`), no `.claude/skills/`**: el destino es mirror real (BR-032) y el próximo `sdd sync` lo pisa. _(tarea 017)_
