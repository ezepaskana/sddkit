...
| Sesión larga monolítica acumulando complejidad | Pausá la tarea y replanificá los pasos restantes | Si llevás 6 pasos seguidos y el contexto supera ~100K tokens → pasá la tarea a `paused` en el índice, replanificá desde el paso actual con contexto fresco |
